 ...
 * <p>
 * This is normally fixable by calling {@link com.nickrammos.jflux.JFluxClient#useDatabase(String)}
 * with the desired database argument, before calling the operation which caused the exception.
 */
